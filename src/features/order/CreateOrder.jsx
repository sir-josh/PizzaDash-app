      ...
      <Form method="POST" action="/order/new">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            />
            {addressStatus === "error" && (
              <p className="mt-2 rounded-lg bg-red-200 p-2 text-xs text-red-700">
                {addressError}
              </p>
            )}
          </div>
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[34px] z-50  sm:top-[2px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
...
export async function action({ request }) {
  ...
  // DO NOT OVERUSE:- causes performance issue
