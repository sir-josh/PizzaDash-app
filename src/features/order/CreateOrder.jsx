      ...
      <Form method="POST" action="/order/new">
        ...
        <div>
          ...
          <div>
            <input
              ...
              text-sm transition-all duration-300 focus:outline-none 
        ...
        <div>
          ...
          <button
            ...
            className="focus: inline-block rounded-full 
             bg-yellow-400 px-4 py-3 font-bold uppercase tracking-wide
              text-stone-800 transition-colors hover:bg-yellow-300 
